# -*- coding: utf-8 -*-
"""
Created on Fri Apr 10 13:38:36 2020
...
#EDIT FILE NAME AT LINE 154| FORMAT: kits002province| Example: kits002pampanga
#EDIT FILE NAME AT LINE 157| FORMAT: kits002province.csv| Example: kits002pampanga.csv
...
#==============================================================================
    ...
    plt.show
    plt.savefig('kits002NCR', dpi = 300)
    df=DataFrame({'time':t,'0ac':x1[:,0],'200ac':x1[:,1],'400ac':x1[:,2],'600ac':x1[:,3],'800ac':x1[:,4],'1000ac':x1[:,5], \
                  '0dac':y1[:,0],'200dac':y1[:,1],'400dac':y1[:,2],'600dac':y1[:,3],'800dac':y1[:,4],'1000dac':y1[:,5]})
    df.to_csv('kits002NCR.csv')